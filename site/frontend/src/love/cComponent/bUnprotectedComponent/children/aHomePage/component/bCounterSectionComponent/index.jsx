              ...
              return (
                <React.Fragment key={index}>
                  <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                    <div className="bg-[#008970] dark:bg-[#99EEDF] text-[#99EEDF] dark:text-[#008970] bg-opacity-60 px-4 py-6 rounded-lg">
                      {
                        each.title === "Frontend Application Deployed" ? (
                          <div className="w-12 h-12 mb-3 inline-flex items-center justify-center rounded-full bg-[#99EEDF] dark:bg-[#008970] text-[#008970] dark:text-[#99EEDF] flex-shrink-0">
