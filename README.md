...
- Open the terminal in any preferred location, create a folder name `CapellaApplication`, and move inside with the following command.
```
mkdir CapellaApplication
```
```
cd CapellaApplication
```
...
```
git clone https://github.com/ApurvChatur/CapellaApplication.git
```
...
- Kindly, check the documentation properly and ensure you are setting up the backend for `CapellaApplication`.

## Administration Installation
- Please ensure you have set up the backend for `CapellaApplication`, before setting up the admin.
...
- Kindly, check the documentation properly and ensure you are setting up the administration for `CapellaApplication`.